...
add_path() {
	...
	while true; do
		...
		"HyperOS")
			echo "已选择 HyperOS"
			options_order=("移除小爱翻译" "移除小爱语音组件" "移除小爱通话" "移除互联互通服务验证" "移除浏览器" "移除音乐与视频" "移除钱包" "移除广告分析相关组件" "移除自带输入法" "移除传送门" "移除智能助理" "移除搜索功能" "移除悬浮球" "移除应用商店" "移除反馈" "移除系统更新" "移除相册" "移除文件管理器" "移除智能密码管理" "移除家人守护" "移除下载管理器" "移除多余应用" "移除所有" "反向移除" "快速替换" "添加应用到 Product 分区" "禁用未签名验证" "调用原生安装器" "禁止主题还原" "禁用热点名称还原" "小米智能卡支持" "高级材质支持" "关键性 Deodex" "禁用 Avb2.0 校验" "返回工作域" "退出程序")
			declare -A options
			options=(
		...
		"OneUI")
			echo "已选择 OneUI"
			options_order=("移除三星浏览器" "移除开机验证" "移除官方恢复模式还原" "移除主页负一屏" "移除动态表情相关组件" "移除 Bixby 语音组件" "移除微软输入法" "移除捆绑的谷歌系应用" "移除穿戴设备管理器" "移除系统更新" "移除主题商店" "移除失效的 Knox 系应用" "移除不常用应用" "移除所有" "反向移除" "快速替换" "添加应用到 System 分区" "添加网速显示" "添加通话录音" "添加相机静音" "禁用未签名验证" "关键性 Deodex" "禁用 Avb2.0 校验" "解码 csc" "编码 csc" "返回工作域" "退出程序")
			declare -A options
			options=(
		...
		"ColorOS")
			echo "已选择 ColorOS"
			options_order=(
				"移除浏览器" "移除自带输入法" "移除广告组件" "移除悬浮球" "移除所有" "反向移除" "快速替换" "关键性 Deodex" "禁用 Avb2.0 校验" "返回工作域" "退出程序"
			)
			declare -A options
			options=(
